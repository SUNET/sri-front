  ...
  renderList() {
    ...
    return (
      <tbody>
        {providers &&
          providers.providers &&
          providers.providers.edges.map(({ node }) => {
            return (
              <this.ROW_COMPONENT
                key={node.id}
                provider={node}
...
export default createPaginationContainer(
  ...
  },
  {
    ...
    query: graphql`
      ...
      query ProviderListForwardQuery($count: Int!, $cursor: String, $orderBy: ProviderOrderBy) {
        ...ProviderList_providers @arguments(count: $count, cursor: $cursor, orderBy: $orderBy)
      }
    `,
