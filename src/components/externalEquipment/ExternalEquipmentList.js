...
export class ExternalEquipmentList extends React.Component {
  MODEL_NAME = 'externalEquipment';
  MODEL_LIST_NAME = 'externalEquipments';
  ROW_COMPONENT = ROW_COMPONENT;
  static propTypes = {
    externalEquipments: PropTypes.object,
  };
  ...
  renderList() {
    let { externalEquipments } = this.props;

    return (
      <tbody>
        {externalEquipments &&
          externalEquipments.externalEquipments &&
          externalEquipments.externalEquipments.edges.map(({ node }) => {
            return (
              <this.ROW_COMPONENT
                key={node.id}
                externalEquipment={node}
  ...
  render() {
    const { t, externalEquipments } = this.props;
...
export default createPaginationContainer(
  ...
  },
  {
    ...
    query: graphql`
      ...
      query ExternalEquipmentListForwardQuery($count: Int!, $cursor: String, $orderBy: ExternalEquipmentOrderBy) {
        ...ExternalEquipmentList_externalEquipments @arguments(count: $count, cursor: $cursor, orderBy: $orderBy)
      }
    `,
