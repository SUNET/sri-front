...
export type UserInputType = {|
  username: string
|};
export type DropdownSearchAllPortsQueryVariables = {|
  filter?: ?PortFilter
|};
export type DropdownSearchAllPortsQueryResponse = {|
  +ports: ?{|
    +edges: $ReadOnlyArray<?{|
      +node: ?{|
        +id: string,
  ...
  |}
|};
export type DropdownSearchAllPortsQuery = {|
  variables: DropdownSearchAllPortsQueryVariables,
  response: DropdownSearchAllPortsQueryResponse,
|};
*/


/*
query DropdownSearchAllPortsQuery(
  $filter: PortFilter
) {
  ports(filter: $filter) {
    edges {
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "DropdownSearchAllPortsQuery",
    "selections": (v1/*: any*/),
    "type": "Query"
  },
  "kind": "Request",
  ...
  "params": {
    ...
    "name": "DropdownSearchAllPortsQuery",
    "operationKind": "query",
    "text": "query DropdownSearchAllPortsQuery(\n  $filter: PortFilter\n) {\n  ports(filter: $filter) {\n    edges {\n      node {\n        id\n        name\n      }\n    }\n  }\n}\n"
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '20e9e1860bd0ef451223937871ee48bf';
