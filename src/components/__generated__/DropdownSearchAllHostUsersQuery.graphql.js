...
export type HostUserFilter = {|
  AND?: ?$ReadOnlyArray<HostUserNestedFilter>,
  OR?: ?$ReadOnlyArray<HostUserNestedFilter>,
|};
export type HostUserNestedFilter = {|
  name?: ?string,
  name_not?: ?string,
  name_lt?: ?string,
  name_lte?: ?string,
...
export type UserInputType = {|
  username: string
|};
export type DropdownSearchAllHostUsersQueryVariables = {|
  filter?: ?HostUserFilter
|};
export type DropdownSearchAllHostUsersQueryResponse = {|
  +hostUsers: ?{|
    +edges: $ReadOnlyArray<?{|
      +node: ?{|
        +id: string,
  ...
  |}
|};
export type DropdownSearchAllHostUsersQuery = {|
  variables: DropdownSearchAllHostUsersQueryVariables,
  response: DropdownSearchAllHostUsersQueryResponse,
|};
*/


/*
query DropdownSearchAllHostUsersQuery(
  $filter: HostUserFilter
) {
...
v1 = [
  {
    ...
    "concreteType": "hostUserConnection",
    "kind": "LinkedField",
    "name": "hostUsers",
    "plural": false,
    "selections": [
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "DropdownSearchAllHostUsersQuery",
    "selections": (v1/*: any*/),
    "type": "Query"
  },
  "kind": "Request",
  ...
  "params": {
    ...
    "name": "DropdownSearchAllHostUsersQuery",
    "operationKind": "query",
    "text": "query DropdownSearchAllHostUsersQuery(\n  $filter: HostUserFilter\n) {\n  hostUsers(filter: $filter) {\n    edges {\n      node {\n        id\n        name\n      }\n    }\n  }\n}\n"
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '6e85f9ca8f3ce9c2d276db0526bdab06';
