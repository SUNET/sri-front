...
export default createPaginationContainer(
  ...
  },
  {
    ...
    query: graphql`
      ...
      query HostListForwardQuery($count: Int!, $cursor: String, $orderBy: HostOrderBy) {
        ...HostList_hosts @arguments(count: $count, cursor: $cursor, orderBy: $orderBy)
      }
    `,
