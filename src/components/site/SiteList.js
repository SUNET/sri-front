...
export default createPaginationContainer(
  ...
  },
  {
    ...
    query: graphql`
      ...
      query SiteListForwardQuery($count: Int!, $cursor: String, $orderBy: SiteOrderBy) {
        ...SiteList_sites @arguments(count: $count, cursor: $cursor, orderBy: $orderBy)
      }
    `,
