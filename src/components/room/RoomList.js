...
export default createPaginationContainer(
  ...
  },
  {
    ...
    query: graphql`
      ...
      query RoomListForwardQuery($count: Int!, $cursor: String, $orderBy: RoomOrderBy) {
        ...RoomList_rooms @arguments(count: $count, cursor: $cursor, orderBy: $orderBy)
      }
    `,
