...
export class OpticalMultiplexSectionList extends React.Component {
  MODEL_NAME = 'opticalMultiplexSection';
  MODEL_LIST_NAME = 'opticalMultiplexSections';
  ROW_COMPONENT = ROW_COMPONENT;
  static propTypes = {
    opticalMultiplexSections: PropTypes.object,
  };
  ...
  renderList() {
    let { opticalMultiplexSections } = this.props;

    return (
      <tbody>
        {opticalMultiplexSections &&
          opticalMultiplexSections.opticalMultiplexSections &&
          opticalMultiplexSections.opticalMultiplexSections.edges.map(({ node }) => {
            return (
              <this.ROW_COMPONENT
                key={node.id}
                opticalMultiplexSection={node}
  ...
  render() {
    const { t, opticalMultiplexSections } = this.props;
