...
export class ODFList extends React.Component {
  MODEL_NAME = 'odf';
  MODEL_LIST_NAME = 'odfs';
  ROW_COMPONENT = ROW_COMPONENT;
  static propTypes = {
    ODFs: PropTypes.object,
  };
...
export default createPaginationContainer(
  ...
  },
  {
    ...
    query: graphql`
      ...
      query ODFListForwardQuery($count: Int!, $cursor: String, $orderBy: ODFOrderBy) {
        ...ODFList_odfs @arguments(count: $count, cursor: $cursor, orderBy: $orderBy)
      }
    `,
