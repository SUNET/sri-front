...
} from '../common/formsSections/OwnedEquipmentToggleSection.js';

// const

class _CustomerFormParentClass extends _BasicFormParentClass {
  // GLOBAL VARs
  ...
  renderSections(editMode) {
    ...
    return (
      <>
        ...
        {renderOwnedEquipmentToggleSection(editMode, this)}
