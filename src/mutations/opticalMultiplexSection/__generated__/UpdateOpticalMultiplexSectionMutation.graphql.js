...
export type CompositeOpticalMultiplexSectionMutationInput = {|
  create_input?: ?CreateOpticalMultiplexSectionInput,
  update_input?: ?UpdateOpticalMultiplexSectionInput,
...
export type DeletePeeringGroupInput = {|
  ...
  clientMutationId?: ?string,
|};
export type UpdateOpticalMultiplexSectionMutationVariables = {|
  input: CompositeOpticalMultiplexSectionMutationInput
|};
export type UpdateOpticalMultiplexSectionMutationResponse = {|
  ...
  |}
|};
export type UpdateOpticalMultiplexSectionMutation = {|
  variables: UpdateOpticalMultiplexSectionMutationVariables,
  response: UpdateOpticalMultiplexSectionMutationResponse,
|};
*/


/*
mutation UpdateOpticalMultiplexSectionMutation(
  $input: CompositeOpticalMultiplexSectionMutationInput!
) {
...
var v0 = [
  {
    ...
    "kind": "LocalArgument",
    "name": "input",
    "type": "CompositeOpticalMultiplexSectionMutationInput!"
  }
],
v1 = [
  {
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "UpdateOpticalMultiplexSectionMutation",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
        "concreteType": "CompositeOpticalMultiplexSectionMutationPayload",
        "kind": "LinkedField",
        "name": "composite_opticalMultiplexSection",
        "plural": false,
        "selections": [
          {
            "alias": null,
            "args": null,
            "concreteType": "UpdateOpticalMultiplexSectionPayload",
            "kind": "LinkedField",
            "name": "updated",
            "plural": false,
            "selections": [
  ...
  "params": {
    ...
    "text": "mutation UpdateOpticalMultiplexSectionMutation(\n  $input: CompositeOpticalMultiplexSectionMutationInput!\n) {\n  composite_opticalMultiplexSection(input: $input) {\n    updated {\n      errors {\n        field\n        messages\n      }\n      opticalMultiplexSection {\n        id\n        name\n        description\n        operational_state {\n          name\n          value\n          id\n        }\n        provider {\n          id\n          name\n        }\n        dependencies {\n          id\n          name\n          __typename\n          relation_id\n          ... on Port {\n            type: port_type {\n              name\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n"
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '2c3b690add75dd0edc6ac0862f730977';
