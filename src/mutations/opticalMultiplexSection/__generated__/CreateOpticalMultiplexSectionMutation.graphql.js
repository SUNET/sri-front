...
export type DeletePeeringGroupInput = {|
  ...
  clientMutationId?: ?string,
|};
export type CreateOpticalMultiplexSectionMutationVariables = {|
  input: CompositeOpticalMultiplexSectionMutationInput
|};
export type CreateOpticalMultiplexSectionMutationResponse = {|
  ...
  |}
|};
export type CreateOpticalMultiplexSectionMutation = {|
  variables: CreateOpticalMultiplexSectionMutationVariables,
  response: CreateOpticalMultiplexSectionMutationResponse,
|};
*/


/*
mutation CreateOpticalMultiplexSectionMutation(
  $input: CompositeOpticalMultiplexSectionMutationInput!
) {
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "CreateOpticalMultiplexSectionMutation",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
        ...
        "selections": [
          {
            "alias": null,
            "args": null,
            "concreteType": "CreateOpticalMultiplexSectionPayload",
            "kind": "LinkedField",
            "name": "created",
            "plural": false,
            "selections": [
  ...
  "params": {
    ...
    "text": "mutation CreateOpticalMultiplexSectionMutation(\n  $input: CompositeOpticalMultiplexSectionMutationInput!\n) {\n  composite_opticalMultiplexSection(input: $input) {\n    created {\n      errors {\n        field\n        messages\n      }\n      opticalMultiplexSection {\n        id\n        name\n        description\n        operational_state {\n          name\n          value\n          id\n        }\n        provider {\n          id\n          name\n        }\n        dependencies {\n          id\n          name\n          __typename\n          relation_id\n          ... on Port {\n            type: port_type {\n              name\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n}\n"
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = 'e2ae307904fe5ed1e53336dd04d9021e';
