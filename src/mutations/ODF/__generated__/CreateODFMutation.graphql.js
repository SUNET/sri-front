...
export type DeleteOpticalFilterInput = {|
  ...
  clientMutationId?: ?string,
|};
export type CreateODFMutationVariables = {|
  input: CompositeODFMutationInput
|};
export type CreateODFMutationResponse = {|
  +composite_oDF: ?{|
    +created: ?{|
  ...
  |}
|};
export type CreateODFMutation = {|
  variables: CreateODFMutationVariables,
  response: CreateODFMutationResponse,
|};
*/


/*
mutation CreateODFMutation(
  $input: CompositeODFMutationInput!
) {
...
return {
  ...
  "params": {
    ...
    "text": "mutation CreateODFMutation(\n  $input: CompositeODFMutationInput!\n) {\n  composite_oDF(input: $input) {\n    created {\n      errors {\n        field\n        messages\n      }\n      oDF {\n        id\n        name\n        description\n        operational_state {\n          name\n          value\n          id\n        }\n        rack_units\n        rack_position\n        rack_back\n        max_number_of_ports\n        ports {\n          id\n          name\n          __typename\n          relation_id\n          type: port_type {\n            name\n            id\n          }\n        }\n      }\n    }\n  }\n}\n"
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = 'bae919ebac9e379f56d6f47d5446e309';
