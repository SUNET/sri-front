...
export type DeletePeeringGroupInput = {|
  ...
  clientMutationId?: ?string,
|};
export type UpdateOpticalLinkMutationVariables = {|
  input: CompositeOpticalLinkMutationInput
|};
export type UpdateOpticalLinkMutationResponse = {|
  ...
  |}
|};
export type UpdateOpticalLinkMutation = {|
  variables: UpdateOpticalLinkMutationVariables,
  response: UpdateOpticalLinkMutationResponse,
|};
*/


/*
mutation UpdateOpticalLinkMutation(
  $input: CompositeOpticalLinkMutationInput!
) {
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "UpdateOpticalLinkMutation",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
        ...
        "selections": [
          {
            "alias": null,
            "args": null,
            "concreteType": "UpdateOpticalLinkPayload",
            "kind": "LinkedField",
            "name": "updated",
            "plural": false,
            "selections": [
  ...
  "params": {
    ...
    "text": "mutation UpdateOpticalLinkMutation(\n  $input: CompositeOpticalLinkMutationInput!\n) {\n  composite_opticalLink(input: $input) {\n    updated {\n      errors {\n        field\n        messages\n      }\n      opticalLink {\n        id\n        name\n        description\n        operational_state {\n          name\n          value\n          id\n        }\n        type: link_type {\n          id\n          name\n          value\n        }\n        interface_type {\n          id\n          name\n          value\n        }\n        provider {\n          id\n          name\n        }\n        ports {\n          id\n          name\n          __typename\n          relation_id\n          type: port_type {\n            name\n            id\n          }\n        }\n      }\n    }\n  }\n}\n"
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '5e4368c53795e4f97d2ec7c360172424';
