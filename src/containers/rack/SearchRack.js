...
import SearchRack from '../../components/rack/SearchRack';
...
const SearchRackContainer = connect(mapStateToProps, mapDispatchToProps)(SearchRack);

export default SearchRackContainer;
