...
import RouterDetails from '../../components/router/RouterDetails';
...
const RouterDetailsContainer = connect(mapStateToProps, mapDispatchToProps)(RouterDetails);

export default RouterDetailsContainer;
