...
import OpticalPathDetails from '../../components/opticalPath/OpticalPathDetails';
...
const OpticalPathDetailsContainer = connect(mapStateToProps, mapDispatchToProps)(OpticalPathDetails);

export default OpticalPathDetailsContainer;
