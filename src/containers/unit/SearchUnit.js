...
import SearchUnit from '../../components/unit/SearchUnit';
...
const SearchUnitContainer = connect(mapStateToProps, mapDispatchToProps)(SearchUnit);

export default SearchUnitContainer;
